...
public:
    explicit TimelineView(QWidget* parent = nullptr, QTimer* timer = nullptr, GraphContainerSyncState *syncState = nullptr, bool sliderVisible = true, bool chevronVisible = true, int timeModeButtonHeight = TIMELINE_VIEW_BUTTON_SIZE / 2, int intervalButtonHeight = TIMELINE_VIEW_BUTTON_SIZE / 2, bool showTimeModeButton = true);
    ~TimelineView();
