...
signals:
    ...
    /**
     * @brief Emitted when an RTW ruler indicator is clicked.
     * Returns the ruler's timestamp; does not change selection (API-only).
    ...
    /**
     * @brief Emitted when a BTW ruler indicator is clicked.
     * Returns the ruler's timestamp; does not change selection (API-only).
     */
